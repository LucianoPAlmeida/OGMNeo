...
const ORMNeoQuery = require('./ormneo-query');
...
class ORMNeoNode {
    ...
    */
    ...
    /**
        ...
        *
        * @static
        * @param {ORMNeoQuery} query - The query to filter the nodes.
    ...
    static updateMany(query, newProperties) {
        return new Promise((resolve, reject) => {
            if (_.isObject(newProperties)) {
                ...
                if (!_.isEmpty(value)) {
                    ORMNeoObjectParse.parseProperties(value);
                    if (query instanceof ORMNeoQuery) {
                        let objectString = ORMNeoObjectParse.objectString(value);
                        ...
                        reject(new Error('The query object must be an instance of ORMNeoQuery'));
                    }
                } else {
                    resolve([]);
                }
    ...
    */
    static countWithLabel(label) {
        return this.count(new ORMNeoQuery(label));
    }
    ...
    */
    static count(query) {
        return new Promise((resolve, reject) => {
            if (query && query instanceof ORMNeoQuery) {
