...
class ORMRelation {
    ...
    */
    ...
    /**
        ...
        * @param {ORMNeoQuery} [propertiesFilter=null] - Query object to be applied on find.
    ...
    */
    ...
    /**
        ...
        * @param {string} [name=null] - Relation type name.
        * @param {ORMNeoQuery} [propertiesFilter=null] - Query object to be applied on find.
        * @returns {Promise.<boolean|Error>}  Deleted nodes if fulfilled, or some neo4j error if rejected.
    */
